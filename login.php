<?php
	//CONECTA USUARIO A BASE DE DATOS
	session_start();
	//conexion a la base de datos
	require 'pag/conex.php';
		...
		if ($vcontrasena == $vusrclavebd) {
			...
			if ($vusrpermisobd == 2) {
				echo'
					<html>
						<head>
							<meta http-equiv="REFRESH" content="0;url=pag/principal.php">
						</head>
					</html>
				';
				...
				echo'
					<html>
						<head>
							<meta http-equiv="REFRESH" content="0;url=pag/consulta.php">
						</head>
					</html>
				';
				...
				echo'
					<html>
						<head>
							<meta http-equiv="REFRESH" content="0;url=pag/usradm.php">
						</head>
					</html>
				';
			}
